...
| 2026-07-26 | Topic 030 (Document Stores) — Completed same session as a condensed SKIM-tier pass (10 min, per TopicPriority.md — "fold into 028"). Covered the two angles beyond Topic 028: nested document structure vs Wide-Column's flat columns, and flexible secondary indexing vs Wide-Column's rigid partition-key-first access. No separate revision file created per tier protocol. | Topic 031 — Choosing a Database |
...
| 030 | Document Stores | Completed (SKIM) | 2026-07-26 | 2026-07-26 | — | — | — | — | — | Easy | Condensed pass, no revision file per tier protocol — clean understanding of nesting + flexible secondary indexing as the two new angles beyond Topic 028 |
